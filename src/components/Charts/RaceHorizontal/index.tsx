...
export const RaceHorizontal = () => {
  ...
  return (
    <ResponsiveBar
      ...
      maxValue={maxValue}
      data={race}
      keys={["All-white founding team", "Non-white/Diverse founding team"]}
      indexBy="label"
      margin={{
      ...
      colors={({ id }: any) => {
        return id === "Non-white/Diverse founding team" ? "#D98F39" : "#31A078";
      }}
      labelTextColor={({ data }: any) => {
