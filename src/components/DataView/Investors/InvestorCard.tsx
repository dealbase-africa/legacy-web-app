          ...
          return (
            ...
            <Box key={columnKey} {...restOfColumnProps}>
              <Flex gap={4} alignItems="flex-start">
                {row.original.investor.logo?.cloudinaryPublicId && (
                  <CloudinaryImage
                    publicId={row.original.investor.logo.cloudinaryPublicId}
                    display="flex"
                    alignItems="center"
                    ...
                    bg="white"
                    p={0}
                    alt={`${row.original.investor.name} Logo`}
                    border="1px solid"
          ...
          return (
            <React.Fragment key={columnKey}>
              ...
              <Flex
                ...
                alignItems="center"
              >
                {row.original.investor.website ? (
                  <LinkText
                    href={row.original.investor.website}
                    label={"Visit Website"}
                    color="white"
                    paddingInlineEnd={3}
