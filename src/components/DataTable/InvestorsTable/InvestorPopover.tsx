      ...
      >
        <PopoverHeader fontWeight="semibold">
          <Flex gap={4} alignItems="center">
            {investor.investor.logo?.cloudinaryPublicId && (
              <CloudinaryImage
                publicId={investor.investor.logo.cloudinaryPublicId}
                imageWidth={64}
                alt={`${name} Logo`}
              ...
              <Flex gap={4} alignItems="center">
                {investor.investor.logo?.cloudinaryPublicId && (
                  <CloudinaryImage
                    publicId={investor.investor.logo.cloudinaryPublicId}
                    imageWidth={64}
                    alt={`${investor.investor.name} Logo`}
                    borderRight="1px solid"
                    pr={4}
                    borderColor="gray.200"
                    _dark={{
                ...
                <Flex flexDir="column" justifyContent="center" h="full">
                  <Heading size="md">{investor.investor.name}</Heading>
                  {investor.investor.website && (
                    <Text mt={2} display="flex" gap={2}>
