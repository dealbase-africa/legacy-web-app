...
import { useLogos } from "@dealbase/client";
import { Logo, TableInstanceWithHooks } from "@dealbase/core";
  ...
  return (
    <Flex flexDir="column">
      ...
      >
        {page
          ?.sort((a, b) =>
            (a.original.originalFilename || "").localeCompare(
              b.original.originalFilename || "",
            ),
          )
          .map((row: Row<Logo>) => {
            prepareRow(row);
