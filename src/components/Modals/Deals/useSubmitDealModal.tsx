...
import { useSaveCrowdsourcedDeal } from "@dealbase/client";
import { CrowdsourcedDeal } from "@dealbase/db";
import { stages } from "@dealbase/fixtures";
...
export const SubmitDealModalBase = ({
  ...
  const { saveCrowdsourcedDeal, isPending } = useSaveCrowdsourcedDeal(onClose);
