      ...
      >
        <PopoverHeader mb={4} fontWeight="semibold">
          <Flex gap={4} alignItems="center">
            {company.logo?.cloudinaryPublicId && (
              <CloudinaryImage
                publicId={company.logo.cloudinaryPublicId}
                display="flex"
                alignItems="center"
            ...
            <Flex flexDir="column" justifyContent="center" h="full">
              ...
              <Text>
                {
                  countryList.find(
                    (item) => item.code === company.country?.isoCode,
                  )?.name
                }
              </Text>
            </Flex>
        ...
        <PopoverBody>
          ...
          >
            <Box maxW="lg" alignItems="left">
              ...
              <Text align="left" display="flex" gap={2}>
                <Text as="span" fontWeight="bold">
                  Website:
                </Text>
                <Link
              ...
              <Text align="left">
                ...
                <Text w="70%" whiteSpace="break-spaces" align="left" as="span">
                  {`${company.about}`}
                </Text>
              </Text>
            </Box>
